			...
			<div className="navbar-start">
				<div className="dropdown">
					...
					<ul tabIndex={0} className="p-2 mt-3 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
						...
						<li>
							<a href="/" className="p-2 mt-3 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">Logout</a>
						</li>
					</ul>
				</div>
				<a href='/' className="text-xl normal-case btn btn-ghost">Walker Store</a>
			</div>
